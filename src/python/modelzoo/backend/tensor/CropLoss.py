...
class CropLoss(Loss):
    ...
    def _get_iou(box1, box2):
        ...
        :return: iou
        """
        box1_ul, box1_br, box1_area = CropLoss._get_box_limits(box1[:, :, :, :, :2], box1[:, :, :, :, 3])
        box2_ul, box2_br, box2_area = CropLoss._get_box_limits(box2[:, :, :, :, :2], box2[:, :, :, :, 3])
        intersect = CropLoss._get_intersect(box1_ul, box1_br, box2_ul, box2_br)
    ...
    def _assign_anchors(y_true, y_pred):
        ...
        iou = CropLoss._get_iou(coord_true, coord_pred)
