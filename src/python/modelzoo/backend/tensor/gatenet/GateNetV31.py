...
from keras.layers import Conv2D, BatchNormalization, MaxPooling2D, LeakyReLU, Reshape, Lambda, AtrousConv2D, Concatenate
...
class GateNetV31(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        # 13
        conv41 = Conv2D(12, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(pool3)
        conv42 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(6, 6), strides=(1, 1), padding='same', use_bias=False)(
            pool3)
        conv43 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(9, 9), strides=(1, 1), padding='same', use_bias=False)(
            pool3)
        conv44 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(12, 12), strides=(1, 1), padding='same', use_bias=False)(
            pool3)
        conv45 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(15, 15), strides=(1, 1), padding='same', use_bias=False)(
            pool3)
        conv4 = Concatenate()([conv41, conv42, conv43, conv44, conv45])
        norm4 = BatchNormalization()(conv4)
        act4 = LeakyReLU(alpha=0.1)(norm4)

        pool4 = MaxPooling2D((2, 2))(act4)
        conv51 = Conv2D(12, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(pool4)
        conv52 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(6, 6), strides=(1, 1), padding='same', use_bias=False)(
            pool4)
        conv53 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(9, 9), strides=(1, 1), padding='same', use_bias=False)(
            pool4)
        conv54 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(12, 12), strides=(1, 1), padding='same', use_bias=False)(
            pool4)
        conv55 = Conv2D(12, kernel_size=(3, 3), dilation_rate=(15, 15), strides=(1, 1), padding='same', use_bias=False)(
            pool4)
        conv5 = Concatenate()([conv51, conv52, conv53, conv54, conv55])
