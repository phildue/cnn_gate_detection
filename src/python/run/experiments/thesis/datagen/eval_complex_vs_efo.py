...
for model in models:
    for i in range(n_iterations):
        ...
        #         result_file='predictions_iros2018gate_random_test.pkl',
        #         batch_size=16,
        #         model_src=work_dir + model_folder,
        #         preprocessing=None,
        #         color_format='bgr',
        #         image_source=['resource/ext/samples/iros2018gate_random_test/'])
        ...
        for iou_thresh in [0.4, 0.6, 0.8]:
            evalmetric(name='total_iou{}'.format(iou_thresh),
                       ...
                       model_src=work_dir + model_folder,
                       color_format='bgr',
                       label_file=work_dir + model_folder + '/test/predictions_iros2018gate_random_test.pkl',
                       result_path=work_dir + model_folder + '/test/',
                       show=False)
