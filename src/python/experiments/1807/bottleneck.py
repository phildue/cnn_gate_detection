...
architecture = [
    ...
    {'name': 'bottleneck_conv', 'kernel_size': (6, 6), 'filters': 32, 'strides': (1, 1), 'alpha': 0.1,
     'compression': 0.5},
    {'name': 'max_pool', 'size': (2, 2)},

    {'name': 'bottleneck_conv', 'kernel_size': (6, 6), 'filters': 64, 'strides': (1, 1), 'alpha': 0.1,
     'compression': 0.5},
    {'name': 'max_pool', 'size': (2, 2)},
...
train(architecture=architecture,
      work_dir='1807/bottleneck{}x{}-{}x{}+{}layers'.format(img_res[0], img_res[1], grid[0][0],
                                                            grid[0][1], 9),
      img_res=img_res,
