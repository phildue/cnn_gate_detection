...
distortion_model = BarrelDistortion(img_shape=(480, 640),
                                    ...
                                    scale=0.95)
distortion_model.save('resource/camera_calibration/distortion_model_guess.pkl')

distortion_model = BarrelDistortion.from_file('resource/camera_calibration/distortion_model_guess.pkl')
