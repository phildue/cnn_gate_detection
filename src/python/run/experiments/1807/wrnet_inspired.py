...
architecture = [
    ...
    {'name': 'conv_leaky', 'kernel_size': (6, 6), 'filters': 32, 'strides': (2, 2), 'alpha': 0.1},
    {'name': 'conv_leaky', 'kernel_size': (6, 6), 'filters': 64, 'strides': (2, 2), 'alpha': 0.1},
...
train(architecture=architecture,
      work_dir='wr_inspired{}x{}-{}x{}+{}layers+pyramid'.format(img_res[0], img_res[1], grid[0][0],
                                                                grid[0][1], 9),
      img_res=img_res,
