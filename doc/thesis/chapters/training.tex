...
Where $\sigma_x$ and $\sigma_y$ are the variance in direction x and y and used to model directional (motion) blur. An example can be seen in \Cref{fig:focusblur}.
