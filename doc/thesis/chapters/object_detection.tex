...
\end{enumerate}
	...
	\Cref{fig:perf_width} shows the performance for thinner and wider networks. It is apparent how the performance only undergoes slight variations despite reducing the total number of weights by a factor 1000.
	...
	\Cref{fig:depth_ap_size} shows the performance for bins of different object sizes. It can be seen how the deeper models perform better at larger object sizes. The deepest model however looses on performance for the smaller object sizes.
