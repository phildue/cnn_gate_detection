...
generator = GateGenerator(directories=['resource/ext/samples/industrial_flight'],
...
src_dir = 'out/0108/mavnet_flight208x208/'
...
demo_generator(model, generator, t_show=0, n_samples=150, iou_thresh=0.4, size=summary['img_res'])
