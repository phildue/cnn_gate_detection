...
Traditional methods have in common that the individual steps of the detection pipeline are optimized separately. Furthermore, often the feature extractors are designed manually. Hence, designing such a detector can result in cumbersome application dependent work. Furthermore, the methods seem to have reached a limit in performance in the years of \todo{XX} where almost no improvement in performance was achieved.
