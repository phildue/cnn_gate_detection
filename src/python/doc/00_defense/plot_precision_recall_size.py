...
plt.xticks(np.arange(len(bins) + 1) - 1,
           ['$\\frac{1}{1000}$', '$\\frac{1}{32}$', '$\\frac{1}{16}$', '$\\frac{1}{8}$', '$\\frac{1}{4}$',
            '$\\frac{1}{2}$', '1.0'], fontsize=12)
plt.legend(handles, legend, bbox_to_anchor=(1.0, 1.0), loc='upper right')
...
plt.minorticks_on()
plt.savefig('doc/presentation/view_precision_recall.png', dpi=600)
