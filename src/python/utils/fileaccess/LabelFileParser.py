    ...
    def write_label_xml(self, path: str, labels: [ImgLabel]):
        for l in labels:
            ...
            for obj in l.objects:
                ...
                ET.SubElement(bnd_box, 'xmin').text = '{0:d}'.format(obj.x_min)
                ET.SubElement(bnd_box, 'xmax').text = '{0:d}'.format(obj.x_max)
                ET.SubElement(bnd_box, 'ymin').text = '{0:d}'.format(obj.y_min)
                ET.SubElement(bnd_box, 'ymax').text = '{0:d}'.format(obj.y_max)
