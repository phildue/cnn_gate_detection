...
class GateNetV17(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        conv10 = Conv2D(64, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act9)
        norm10 = BatchNormalization()(conv10)
        act10 = LeakyReLU(alpha=0.1)(norm10)
