...
class GateNetV24(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        w, h = img_shape
        # increased kernel size lower level maps
        input = Input((w, h, 3))
        conv1 = Conv2D(32, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(input)
        ...
        # 26
        conv5 = Conv2D(16, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(pool4)
        norm5 = BatchNormalization()(conv5)
        act5 = LeakyReLU(alpha=0.1)(norm5)
        pool5 = MaxPooling2D((2, 2))(act5)
        # 13
        conv6 = Conv2D(16, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(pool5)
        norm6 = BatchNormalization()(conv6)
        act6 = LeakyReLU(alpha=0.1)(norm6)

        conv7 = Conv2D(16, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act6)
        norm7 = BatchNormalization()(conv7)
        act7 = LeakyReLU(alpha=0.1)(norm7)

        conv8 = Conv2D(16, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act7)
        norm8 = BatchNormalization()(conv8)
        act8 = LeakyReLU(alpha=0.1)(norm8)

        conv9 = Conv2D(16, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act7)
