...
architecture = [
    ...
    {'name': 'max_pool', 'size': (2, 2)},
    {'name': 'wr_inception_conv_leaky', 'kernel_size': (6, 6), 'filters': 64, 'compression': 0.5, 'strides': (1, 1),
     'alpha': 0.1},
    {'name': 'max_pool', 'size': (2, 2)},
    {'name': 'wr_basic_conv_leaky', 'kernel_size': (6, 6), 'filters': 32, 'strides': (1, 1), 'alpha': 0.1},
    {'name': 'max_pool', 'size': (2, 2)},
    {'name': 'wr_bottleneck_conv_leaky', 'kernel_size': (6, 6), 'filters': 32, 'compression': 0.5, 'strides': (1, 1),
     'alpha': 0.1},

]

train(architecture=architecture,
      work_dir='wr_bottleneck_gatenet{}x{}-{}x{}+{}layers+pyramid'.format(img_res[0], img_res[1], grid[0][0],
                                                                          grid[0][1], 10),
      img_res=img_res,
