...
Knowledge Distillation \cite{Hinton2006} is way to create a smaller network based on a trained bigger network. Thereby the smaller student-network is trained to mimic the output of the final and intermediate activations of the teacher-network. The aim is to decrease the complexity and inference time of the model without loosing performance. 

The line of research investigated how to decrease the width of a network or how to
