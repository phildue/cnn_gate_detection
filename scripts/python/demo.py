...
generator = GateGenerator(directory='resource/samples/stream_valid1/', batch_size=1, color_format='bgr',
...
model = Yolo.yolo_v2(class_names=['gate'], conf_thresh=0.4, color_format='yuv',
