...
class SSDLoss:
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        n_positive = K.print_tensor(n_positive, "N positive")
        ...
        n_neg_losses = K.print_tensor(n_neg_losses, "N neg losses")
        ...
        n_negative_keep = tf.minimum(tf.maximum(self.neg_pos_ratio * tf.to_int32(n_positive), self.n_neg_min),
                                     n_neg_losses)
        n_negative_keep = K.print_tensor(n_negative_keep, "N negative keep")
        ...
        neg_class_loss = K.print_tensor(neg_class_loss, "Neg loss")
        pos_class_loss = K.print_tensor(pos_class_loss, "Pos loss")
        ...
        loc_loss = K.print_tensor(loc_loss, "Loc loss")
