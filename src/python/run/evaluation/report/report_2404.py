...
def pr_plot(files, legend, title, line_style=None):
    recalls = []
    precisions = []
    for f in files:
...
pr_basement_all = pr_plot(files=['logs/gatev5_industrial/results/industrial--024.pkl',
                                 ...
                                 'logs/gatev6_mixed/results/industrial--006.pkl',
...
#
# industrial_plot = pr_plot(files=['logs/gatev5_mixed/results/industrial--020.pkl',
#                                  'logs/tiny_mixed/results/industrial--019.pkl',
#                                  'logs/v2_mixed/results/industrial--019.pkl'
#                                  ],
#                           legend=['GateNet-Mixed',
#                                   'Tiny-Mixed',
#                                   'V2-Mixed'
#                                   ],
#                           title='Test on Industrial')
# industrial_plot.show(False)
#
# daylight_plot = pr_plot(files=['logs/gatev5_mixed/results/daylight--019.pkl',
#                                'logs/tiny_mixed/results/daylight--019.pkl',
#                                'logs/v2_mixed/results/daylight--018.pkl'
#                                ],
#                         legend=['GateNet-Mixed',
#                                 'Tiny-Mixed',
#                                 'V2-Mixed'
...
detection_gate6 = detection_plot('logs/gatev6_mixed/results/daylight--005.pkl', 'GateNet6 on Daylight')
...
# detection_gate6.save('doc/report/2018-04-22/fig/detection_gate6.png')
