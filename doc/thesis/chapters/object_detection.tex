	...
	The domain of \acp{MAV} can have particular strong variations due to sensor properties etc. Hence, designing a good filter is difficult. Deep Learning can address these problems.
