...
architecture = [
    ...
    {'name': 'bottleneck_dconv', 'kernel_size': (6, 6), 'filters': 32, 'strides': (1, 1), 'alpha': 0.1, 'expansion': 3},
    {'name': 'max_pool', 'size': (2, 2)},
    {'name': 'bottleneck_dconv', 'kernel_size': (6, 6), 'filters': 64, 'strides': (1, 1), 'alpha': 0.1, 'expansion': 3},
    {'name': 'max_pool', 'size': (2, 2)},
    {'name': 'bottleneck_dconv', 'kernel_size': (6, 6), 'filters': 32, 'strides': (1, 1), 'alpha': 0.1, 'expansion': 3},
    {'name': 'max_pool', 'size': (2, 2)},
    {'name': 'bottleneck_dconv', 'kernel_size': (6, 6), 'filters': 64, 'strides': (1, 1), 'alpha': 0.1, 'expansion': 3},
...
train(architecture=architecture,
      work_dir='2507/mobilegatenetV2{}x{}-{}x{}+{}layers'.format(img_res[0], img_res[1], grid[0][0],
                                                                 grid[0][1], 9),
      img_res=img_res,
