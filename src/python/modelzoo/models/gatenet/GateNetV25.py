...
class GateNetV25(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        conv5 = Conv2D(32, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act4)
        norm5 = BatchNormalization()(conv5)
        act5 = LeakyReLU(alpha=0.1)(norm5)

        conv6 = Conv2D(32, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act5)
        norm6 = BatchNormalization()(conv6)
        act6 = LeakyReLU(alpha=0.1)(norm6)

        conv7 = Conv2D(32, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act6)
