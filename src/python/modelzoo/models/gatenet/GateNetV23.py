...
from keras.layers import Conv2D, MaxPooling2D, Reshape, Lambda, Activation
...
class GateNetV23(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        norm4 = conv4  # BatchNormalization()(conv4)
        ...
        norm5 = conv5  # BatchNormalization()(conv5)
