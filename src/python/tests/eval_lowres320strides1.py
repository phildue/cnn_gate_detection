            ...
            try:
                ...
                for iou in [0.4, 0.6, 0.8]:
                    ...
                    labels_true, labels_pred, img_files = load_predictions(
                        '{}/predictions320_strides1.pkl'.format(prediction_dir))
                    ...
                    frame.to_pickle('{}/results_total_320strides1.pkl'.format(prediction_dir))
                    frame.to_excel('{}/results_total_320strides1.xlsx'.format(prediction_dir))
