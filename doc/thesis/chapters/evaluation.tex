...
\paragraph{Precision}
$$m_p = \frac{\text{true positives}}{\text{true positives} + \text{false positives}}$$

\paragraph{Recall}
$$m_r = \frac{\text{true positives}}{\text{true positives} + \text{false negatives}}$$
...
$$ p_\text{interp} = \max\lim\limits_{r' \geq r} p(r')$$

Subsequently the mean at all recall levels can be calculated. A metric that combines the precision-recall trade-off is \ac{mAP}. This is the mean precision across all recall levels.
