...
from keras.layers import Conv2D, BatchNormalization, MaxPooling2D, LeakyReLU, Reshape, Lambda, SeparableConv2D
...
class GateNetV15(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        w, h = img_shape
        # v10 but depthwise seperable
        input = Input((w, h, 3))
        conv1 = SeparableConv2D(16, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(input)
        norm1 = BatchNormalization()(conv1)
        act1 = LeakyReLU(alpha=0.1)(norm1)
        pool1 = MaxPooling2D((2, 2))(act1)
        # 208
        conv2 = SeparableConv2D(32, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(pool1)
        norm2 = BatchNormalization()(conv2)
        act2 = LeakyReLU(alpha=0.1)(norm2)
        pool2 = MaxPooling2D((2, 2))(act2)
        # 104
        conv3 = SeparableConv2D(64, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(pool2)
        norm3 = BatchNormalization()(conv3)
        act3 = LeakyReLU(alpha=0.1)(norm3)
        pool3 = MaxPooling2D((2, 2))(act3)
        # 52
        conv4 = SeparableConv2D(64, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(pool3)
        norm4 = BatchNormalization()(conv4)
        act4 = LeakyReLU(alpha=0.1)(norm4)
        pool4 = MaxPooling2D((2, 2))(act4)
        # 26
        conv5 = SeparableConv2D(64, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(pool4)
        norm5 = BatchNormalization()(conv5)
        act5 = LeakyReLU(alpha=0.1)(norm5)
        pool5 = MaxPooling2D((2, 2))(act5)
        # 13
        conv6 = SeparableConv2D(64, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(pool5)
        norm6 = BatchNormalization()(conv6)
        act6 = LeakyReLU(alpha=0.1)(norm6)

        conv7 = SeparableConv2D(64, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act6)
        norm7 = BatchNormalization()(conv7)
        act7 = LeakyReLU(alpha=0.1)(norm7)

        conv8 = SeparableConv2D(64, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act7)
