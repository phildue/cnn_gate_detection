...
img_res = 416, 416
for i in range(2,4):
    model_dir = 'distortion_i{0:02d}'.format(i)
    initial_epoch = 0
    epochs = 100
    ...
    preprocessor = Preprocessor(preprocessing=None, encoder=encoder, n_classes=1, img_shape=img_res, color_format='bgr', augmentation=augmenter)
