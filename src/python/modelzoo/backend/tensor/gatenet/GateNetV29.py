...
class GateNetV29(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        # Atrous conv
        input = Input((w, h, 3))
        conv11 = Conv2D(8, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(input)
        conv12 = Conv2D(8, kernel_size=(3, 3), dilation_rate=(6, 6), strides=(1, 1), padding='same', use_bias=False)(
            input)
        ...
        # 208
        conv21 = Conv2D(8, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(pool1)
        conv22 = Conv2D(8, kernel_size=(3, 3), dilation_rate=(6, 6), strides=(1, 1), padding='same', use_bias=False)(
            pool1)
        conv23 = Conv2D(8, kernel_size=(3, 3), dilation_rate=(9, 9), strides=(1, 1), padding='same', use_bias=False)(
            pool1)
        conv24 = Conv2D(8, kernel_size=(3, 3), dilation_rate=(12, 12), strides=(1, 1), padding='same', use_bias=False)(
            pool1)
        ...
        # 56
        conv31 = Conv2D(8, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(pool2)
        conv32 = Conv2D(8, kernel_size=(3, 3), dilation_rate=(6, 6), strides=(1, 1), padding='same', use_bias=False)(
            pool2)
        conv33 = Conv2D(8, kernel_size=(3, 3), dilation_rate=(9, 9), strides=(1, 1), padding='same', use_bias=False)(
            pool2)
