...
cd_work()
example_path = 'resource/ext/samples/test_distort/00045'
img = imread(example_path + '.jpg', 'bgr')
label = XmlParser.read_label(example_path + '.xml')
barrel = BarrelDistortion((240, 320), rad_dist_params=[0.7, 0], tangential_dist_params=[0.7, 0])
...
img_c, label_c = crop(img_d, (40, 40), (280, 200), label_d)
