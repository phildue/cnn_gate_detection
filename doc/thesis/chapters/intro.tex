...
\Cref{fig:race_court} shows examples of the object of interest. As can be seen, the majority of the area that is covered by the object is background. Hence, it can contain all kinds of shapes, including other objects.
