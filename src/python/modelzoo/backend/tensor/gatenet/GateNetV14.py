...
class GateNetV14(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        w, h = img_shape
        # shallow but large filters
        input = Input((w, h, 3))
        conv1 = Conv2D(32, kernel_size=(6, 6), strides=(1, 1), padding='same', use_bias=False)(input)
        norm1 = BatchNormalization()(conv1)
        act1 = LeakyReLU(alpha=0.1)(norm1)
        pool1 = MaxPooling2D((2, 2))(act1)
        # 208
        conv2 = Conv2D(64, kernel_size=(12, 12), strides=(1, 1), padding='same', use_bias=False)(pool1)
        norm2 = BatchNormalization()(conv2)
        act2 = LeakyReLU(alpha=0.1)(norm2)
        pool2 = MaxPooling2D((4, 4))(act2)
        # 52
        conv3 = Conv2D(128, kernel_size=(12, 12), strides=(1, 1), padding='same', use_bias=False)(pool2)
        norm3 = BatchNormalization()(conv3)
        act3 = LeakyReLU(alpha=0.1)(norm3)
        pool3 = MaxPooling2D((4, 4))(act3)
        # 13
        conv4 = Conv2D(256, kernel_size=(12, 12), strides=(1, 1), padding='same', use_bias=False)(pool3)
