...
class GateNetV35(Net):
    ...
    def __init__(self, loss: Loss,
        ...
        conv61 = Conv2D(32, kernel_size=(3, 3), strides=(1, 1), padding='same', use_bias=False)(act5)
        conv62 = Conv2D(32, kernel_size=(3, 3), dilation_rate=(6, 6), strides=(1, 1), padding='same', use_bias=False)(
            act5)
        conv63 = Conv2D(32, kernel_size=(3, 3), dilation_rate=(9, 9), strides=(1, 1), padding='same', use_bias=False)(
            act5)
        conv6 = Concatenate()([conv61, conv62, conv63])
